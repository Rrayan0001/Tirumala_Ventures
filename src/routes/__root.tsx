    ...
    head: () => ({
      meta: [
        ...
        },
        {
          name: "description",
          content:
            "India's premier trading institute. Live trading floor, expert mentors, practical courses, corporate ambience.",
        },
        ...
        { property: "og:title", content: "Tirumala Ventures" },
        {
          ...
          content:
            "Premium trading education and live corporate trading floor.",
        },
        { property: "og:type", content: "website" },
        { name: "twitter:card", content: "summary" },
        { name: "theme-color", content: "#102b20" },
      ],
      links: [
        {
          rel: "icon",
